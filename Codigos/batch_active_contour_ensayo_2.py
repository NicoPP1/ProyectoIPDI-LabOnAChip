...
#Recorro los archivos de forma ordenada
for file in sorted(glob.glob(path),key = key_func):
    ...
    #Guardo las figuras
    fig.savefig('resTest7/deteccion'+str(img_number)+'.jpg',bbox_inches="tight")
